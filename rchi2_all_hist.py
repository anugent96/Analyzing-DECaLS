...
plt.hist(g_comp, color='m', range=(0,100),bins=np.logspace(-0.5, 1.0, 50), alpha=0.7, label= 'COMP', histtype='stepfilled')
plt.hist(g2_rchi2_psf, color='r', range=(0,100), bins=np.logspace(-0.5, 1.0, 50), alpha=0.9, label='Unmasked CRs', histtype='stepfilled')
...
plt.hist(r_comp, color='m', range=(0,100), bins=np.logspace(-0.5, 1.0, 50), alpha=0.7, label= 'COMP', histtype='stepfilled')
plt.hist(r2_rchi2_psf, color='r', range=(0,100), bins=np.logspace(-0.5, 1.0, 50), alpha=0.9, label='Unmasked CRs', histtype='stepfilled')
...
plt.hist(z_comp, color='m', range=(0,100), bins=np.logspace(-.5, 1.5, 50), alpha=0.7, label= 'COMP', histtype='stepfilled')
plt.hist(z2_rchi2_psf, color='r', range=(0,100), bins=np.logspace(-.5, 1.5, 50), alpha=0.9, label='Unmasked CRs', histtype='stepfilled')
